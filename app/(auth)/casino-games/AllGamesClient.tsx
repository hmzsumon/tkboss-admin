...
/* ────────── app/(public)/casino-games/AllGamesClient.tsx ─────────── */
...
export default function AllGamesClient() {
  ...
  const hint = useMemo(() => {
    return "Search by game_uid (e.g. 425) / game name (e.g. Rooster) / brand name";
  }, []);

  return (
    <main className="mx-auto w-full max-w-7xl p-4 md:p-6">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-white">All Casino Games</h1>
        <p className="mt-1 text-sm text-neutral-500">
          Infinite scroll + auto tabs (brands & categories).
        </p>
      </div>
      ...
      <div className="mb-6">
        ...
        <p className="mt-2 text-xs text-neutral-500">
          Tip: just type <span className="text-neutral-300">425</span> for
          game_uid or <span className="text-neutral-300">Rooster</span> for
          name.
        </p>
      </div>
      ...
      <IgamingInfiniteGrid q={debounced} />
    </main>
  );
}
