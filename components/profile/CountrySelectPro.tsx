        ...
        <div className="relative">
          <div className="relative flex items-center">
            <Combobox.Input
              ...
              className="w-full rounded-lg border border-neutral-800 bg-neutral-950 px-3 py-2 pr-9 text-sm text-neutral-200 outline-none placeholder:text-neutral-500 focus:ring-2 focus:ring-emerald-600/40"
            />
